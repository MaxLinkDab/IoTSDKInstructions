...
public class FastDFSClient {
     ...
     * 文件最大的大小
     */
    private static int maxFileSize = 100 * 1000 * 1000;
     ...
     */
    public static String upload(MultipartFile file, Map<String, String> descriptions) throws FastDFSException {
     ...
     */
    public static String upload(InputStream is, String filename, Map<String, String> descriptions) throws FastDFSException {
        if(is == null){
            throw new FastDFSException(ErrorCode.FILE_ISNULL.CODE, ErrorCode.FILE_ISNULL.MESSAGE);
        }
